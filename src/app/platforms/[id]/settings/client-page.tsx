...
export function PlatformSettingsPage({
  ...
  // Fetch existing schedule settings
  ...
  const updateMutation = api.schedule.updateSettings.useMutation({
    onSuccess: async () => {
      setIsDirty(false);
      await utils.schedule.getSettings.invalidate({ platformConnectionId });
  ...
  // Disconnect mutation
  const disconnectMutation = api.platform.disconnect.useMutation({
    onSuccess: async () => {
      router.push("/dashboard");
      await utils.platform.list.invalidate();
    },
    onError: (err) => {
  ...
  const handleDisconnect = () => {
    if (
      ...
      disconnectMutation.mutate({ id: platformConnectionId });
    }
  };
  ...
  return (
    <Box sx={{ maxWidth: 800, mx: "auto", p: 3 }}>
      <Stack direction="row" alignItems="center" spacing={2} mb={4}>
        <Typography variant="h4">Channel Settings</Typography>
      </Stack>
      ...
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary" mb={2}>
          Manage your connection to this platform.
        </Typography>
        <Button
          variant="outlined"
          color="error"
      ...
      <Paper sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary" mb={3}>
          Configure when posts should be automatically published when added to
          the queue.
        </Typography>
